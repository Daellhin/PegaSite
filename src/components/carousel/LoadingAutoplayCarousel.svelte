...
<div class="bg-base-200 rounded-lg p-2 pt-1 animate-pulse">
  <div class="box-content">
    ...
    {/if}
    <div
      class="flex items-center justify-center bg-base-300 w-full rounded-lg h-56 sm:h-96 lg:h-44 2xl:h-52"
    >
